...
const SportCard: React.FC<{ item: SportEvent }> = ({ item }) => {
  return (
    <>
      <div className="bg-[#FFFFFF] dark:bg-[#3B3E47] lg:rounded-b-none lg:rounded-r flex flex-col justify-between leading-normal p-2 group relative hover:border-2 overflow-hidden  rounded-lg  transition-all ">
        <Image
          width={1080}
          height={1080}
          priority={true}
          alt="sports-person"
          src={item?.imgLink}
          className="object-cover h-96 group-hover:h-[300px] transition-all duration-300 z-20"
        />
        <div >
